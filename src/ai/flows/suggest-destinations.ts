// Auto-generated by Genkit. Do not edit.
'use server';
/**
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a ride assistant. Given the user's current location and past ride history, suggest popular destinations. 
...
Suggest destinations (latitude, longitude and a descriptive name) that the user may want to go to.
